            ...
            <div className="grid md:grid-cols-2 gap-4 text-sm">
              <div>
                ...
                <ul className="text-gray-400 space-y-1 list-disc list-inside">
                  <li>
                    <span className="text-green-400">p50 (Median)</span> - Half
                    of requests are faster
                  </li>
                  <li>
                    <span className="text-yellow-400">p95</span> - 95% of
                    requests are faster (excludes outliers)
                  </li>
                  <li>
